      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">Stay updated with the latest innovation metrics and policy recommendations.</p>
              <form className="flex flex-col space-y-2">
                <input 
                  type="email" 
                  placeholder="Your email address" 
                  className="px-4 py-2 rounded-md bg-gray-800 border border-gray-700 text-white focus:outline-none focus:border-innovation-500"
                />
                <Button type="submit" className="bg-innovation-500 hover:bg-innovation-600 text-white">
                  Subscribe
                </Button>
              </form>
            </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} InnovationPulse. All rights reserved.
          </p>
